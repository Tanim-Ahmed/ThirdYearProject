...
class MenuManager: NSObject, UITableViewDelegate, UITableViewDataSource {
    ...
    //let arrayOfSources = ["TechCrunch", "BBC-Sport", "Espn-Cric-Info","Al-Jazeera-English"]
    let arrayOfSources = ["TechCrunch", "BBC-Sport"]
    ...
    public func openMenu() {
        if let window = UIApplication.shared.keyWindow {
            ...
            let height: CGFloat = CGFloat(Int(arrayOfSources.count*50))
